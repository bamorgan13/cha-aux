...
gaben.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
zegyr = User.create({username: 'Zegyr', email: 'ryon@gmail.com', password: 'password'})
zegyr.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
chaos = User.create({username: 'Chaos', email: 'chaos@gmail.com', password: 'password'})
chaos.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
durango = User.create({username: 'Durango', email: 'durango@gmail.com', password: 'password'})
durango.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
jason = User.create({username: 'Jason', email: 'citronator@gmail.com', password: 'password'})
jason.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
justin = User.create({username: 'Justin', email: 'kanman@twitch.tv', password: 'password'})
justin.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
emmett = User.create({username: 'Emmett', email: 'shearbear@twitch.tv', password: 'password'})
emmett.icon_image.attach(io: open(Faker::Avatar.image(nil,"50x50")), filename:"#{user.username}_icon.jpg")
...
User.all.each { |user| aa.memberships.create({user_id: user.id})}
User.all.each { |user| mtga.memberships.create({user_id: user.id})}
